  ...
  return [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Initial Deposit. Before TechSavvy begins the first job under this Agreement, Customer will pay a deposit equal to the minimum billable time stated above, at the applicable hourly rate (the \"Deposit\"), unless TechSavvy agrees in writing to waive it for that job. TechSavvy may delay the start of work, without liability, until the Deposit is received. The Deposit is not an additional fee. TechSavvy will credit it in full against the final invoice for that job. If the job is cancelled before work begins, TechSavvy will hold the Deposit as a credit on Customer's account and apply it to Customer's next invoice. Once the Deposit has been paid for the first job, it is not required again for later jobs.",
