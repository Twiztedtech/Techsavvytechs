...
export function MfaEnrollment({ user, onComplete, onCancel, onSignOut }: { user: User; onComplete: () => void; onCancel: () => void; onSignOut: () => void }) {
